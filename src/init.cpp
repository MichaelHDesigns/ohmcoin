...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-port=<port>", strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 88888, 11773));
    ...
    strUsage += HelpMessageOpt("-karmanodeaddr=<n>", strprintf(_("Set external address:port to get to this karmanode (example: %s)"), "128.127.106.235:88888"));
